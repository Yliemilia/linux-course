...
## e) Pipe
Putkea käytin esimerkiksi jo micro-editorin asentamisessa. Määrittelin komennon _apt-cache searh micro | grep ^micro_ avulla sen, että hakusanaa "micro" haetaan nimenomaan listasta, jossa micro löytyy rivin alusta, eli näin:
<img width="821" height="332" alt="image" src="https://github.com/user-attachments/assets/c27eee6f-f7f8-4bac-a635-103c86358dd2" />
